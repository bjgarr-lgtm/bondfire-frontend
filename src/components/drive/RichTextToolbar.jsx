  ...
  return (
    <div style={{ position: "relative", marginBottom: 6 }}>
      <div className="card" style={{ padding: 5, display: "flex", gap: 4, flexWrap: "wrap", alignItems: "center" }}>
        ...
        <button className="btn" type="button" onClick={onToggleMenu} title="View and document menu" style={{ marginLeft: "auto", padding: "3px 10px", fontSize: 14 }}>
          ☰
        </button>
      </div>
        ...
        >
          {menuItems.map((item, idx) => (
            <button
              ...
              style={{ textAlign: "left", justifyContent: "flex-start", padding: "7px 10px" }}
            >
              {item.label}
            </button>
          ))}
