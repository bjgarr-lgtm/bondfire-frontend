...
export default function Overview() {
  ...
  // Do NOT memoize this: org key can be loaded after mount without orgId changing.
  const getOrgKeyNow = () => (orgId ? getCachedOrgKey(orgId) : null);
  ...
  async function refresh() {
    ...
    try {
      ...
      const [pplD, invD, needD, meetD] = await Promise.all([
        ...
        tryDecryptNeeds(orgKeyNow, needRows),
