...
export const __wbg_get_storedroomkeybundledata_senderUser: (a: number) => number;
export const __wbg_get_storedroomkeybundledata_roomId: (a: number) => number;
...
export const __wbg_get_storedroomkeybundledata_encryptionInfo: (a: number) => [number, number];
export const __wbg_get_storedroomkeybundledata_url: (a: number) => [number, number];
...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9a610c366a7f0d0a: (a: number, b: number) => void;
export const closure751_externref_shim: (a: number, b: number, c: any) => void;
export const closure434_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__Fn_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha55834deaaca03e1: (a: number, b: number) => void;
