...
export async function onRequestGet({ env, params }) {
  ...
  const cleaned = {
    ...
    about_card_title: String(cfg?.about_card_title || ""),
    about_card_body: String(cfg?.about_card_body || ""),
    location_card_title: String(cfg?.location_card_title || ""),
    location_card_body: String(cfg?.location_card_body || ""),
